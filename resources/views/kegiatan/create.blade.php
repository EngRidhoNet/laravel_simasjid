...
@section('contents')
    <h1 class="mb-0">Tambah Data Kegiatan</h1>
    <hr />
    ...
    <form action="{{ route('kegiatan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nama_kegiatan" class="form-control" id="nama_kegiatan" placeholder="Masukkan Nama Kegiatan">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="time" name="waktu_mulai" class="form-control" id="waktu_mulai" placeholder="Masukkan Waktu Mulai">
            </div>
            <label for="waktu_selesai" class="col-sm-1 col-form-label text-end">Selesai:</label>
            <div class="col-sm-4">
                <input type="time" name="waktu_selesai" class="form-control" id="waktu_selesai" placeholder="Masukkan Waktu Selesai">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="tempat" class="form-control" id="tempat" placeholder="Masukkan Tempat Kegiatan">
            </div>
        </div>
